CPP_smooth.volume.FEM.basis<-function(locations, observations, mesh, lambda, covariates = NULL, incidence_matrix = NULL, areal_data = FALSE, ndim, mydim, BC = NULL, GCV,GCVmethod = 2, nrealizations = 100)
{
