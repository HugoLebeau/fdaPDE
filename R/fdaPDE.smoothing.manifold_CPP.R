CPP_smooth.manifold.FEM.basis<-function(locations, observations, mesh, lambda, covariates = NULL, incidence_matrix = NULL, ndim, mydim, BC = NULL, GCV,GCVmethod = 2, nrealizations = 100)
{
